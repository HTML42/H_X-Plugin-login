function xlogin_cookie_set(key, value, days) {
    return xlogin_cookie(key, value, days);
}

function xlogin_cookie_get(key) {
    return xlogin_cookie(key);
}

function xlogin_cookie(key, value, days) {
